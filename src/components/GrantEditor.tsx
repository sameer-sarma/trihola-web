...
import type { OfferGrantLine, PickerItem } from "../types/offerTemplateTypes";
...
const GrantEditor: React.FC<Props> = ({
  ...
  return (
    <div className="th-stack">
      {(value || []).length === 0 && (
        <div className="help">No grants added yet.</div>
      )}
          ...
          {g.itemType === "PRODUCT" ? (
            ...
            <div className="th-field">
              ...
              <input
                ...
                onChange={(e) =>
                  update(i, {
                    bundleId: e.target.value || undefined,
                    productId: undefined,
                  })
                }
              />
